...
<body>
    ...
    <div class="film-detail-container">
        ...
        <div class="rating-section">
            ...
            <?php else: ?>
                <div class="login-prompt">
                    Silakan <a href="signin.php">login</a> untuk memberikan rating.
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="comments-section">
            ...
            <?php else: ?>
                <div class="login-prompt">
                    Silakan <a href="signin.php">login</a> untuk berpartisipasi dalam diskusi.
                </div>
            <?php endif; ?>
